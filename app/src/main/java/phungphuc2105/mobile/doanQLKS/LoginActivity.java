package phungphuc2105.mobile.doanQLKS;
...
import phungphuc2105.mobile.doanQLKS.DAO.QuanLyDAO;
import phungphuc2105.mobile.doanQLKS.DTO.QuanLy;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void checkLogin(){
        strUser = ed_username.getText().toString();
        strPass = ed_password.getText().toString();
        if (strUser.isEmpty()){
